...
| **Amazon Fire TV** (any model) | ❌ | Fire OS swaps Google's services for Amazon's and **has no Android TV Remote Service**. SmartTube itself runs fine there — this app can't reach it. The only alternative would be ADB, which means enabling Developer Options and accepting a dialog on the TV; that's a setup cost this project won't ask of you |
