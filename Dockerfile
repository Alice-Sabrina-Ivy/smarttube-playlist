...
# The ONLY difference between the stable and beta images, and it lives here
...
# means a guest-pressable button that takes over the TV, switched on for every
# stable user with no conflict for anyone to notice.
#
...
# for a stable image or off for a beta one.
ARG CHANNEL=stable
ARG SELF_TEST=0
